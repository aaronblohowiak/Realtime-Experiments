...
"</div><h2>You Are:</h2><div>" + 
this.renderWithReplaceOnUpdate("person", youAre) + 
"</div><h3>Present:</h3><div>" + 
this.renderCollectionWithAddRemove("person", present) + 
